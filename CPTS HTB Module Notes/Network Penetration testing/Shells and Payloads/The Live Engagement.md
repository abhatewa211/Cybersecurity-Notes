...
![Login screen for FreeRDP with fields for session, username, and password.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/115/xfree-login.png)
