# 🛰️ ICMP Tunneling with SOCKS — Detailed Notes

These notes are based **directly on the material you provided**. I’ve kept the important concepts, terminology, commands, IPs, ports, and workflow intact, while organizing them for easier learning and revision.

> **Lab context:** The commands below are for an authorized HTB-style lab. Use tunneling techniques only on systems/networks you are authorized to test.
